...
public class PostEsDaoTest {
    ...
    void testAdd() {
        ...
        postEsDTO.setId(1L);
        postEsDTO.setTitle("海贼王的符号富农为");
        postEsDTO.setContent("ONE PIECE 是我的大撒大青蛙分区方法");
    ...
    @Test
    void testFindByFindByTitle() {
        List<PostEsDTO> postEsDaoTestTitle = postEsDao.findByTitle("海贼");
        System.out.println(postEsDaoTestTitle);
    }
}
